...
# Read STATA file
df = pd.read_stata("/Users/saschajakob/Desktop/Paper 1/return_decomp_data_1980_2019.dta")
...
e1 = np.array([1, 0, 0])
global_gamma = np.array(pd.read_excel("/Users/saschajakob/Desktop/Paper 1/var_coeff_mat.xlsx", index_col=None, header=None))
global_gamma = np.matrix(global_gamma.reshape(3, 3))

columns = ['dealnumber', 'permno', 'ccm_yq', 'pre_cf_lvl', 'post_cf_lvl', 'pre_cf_var',
           'post_cf_var', 'pre_disc_lvl', 'post_disc_lvl', 'pre_disc_var', 'post_disc_var']
...
decomp_df.to_stata('/Users/saschajakob/Desktop/Paper 1/decomp_data_single_gamma_alternative3.dta')
