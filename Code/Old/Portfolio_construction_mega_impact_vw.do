...
*/	
	* Compute returns and number of observations for overall portfolio
	egen totmk = total(mkvalt) if dist == 1 & insample == 1
	...
	* Drop all variables of look and rerun three months later	
	drop dist tag tag2 tag3 insample temp temp2 temp3 temp4 temp5 temp6 obs1 obs2 obs3 obs4 weight t1_weight t2_weight mtemp1-mtemp6 totmk totmk2 ic wic tic tc tw_diff w_diff
		
	}
	
	drop quarter_w_diff_top quarter_w4_top quarter_w_diff_bottom quarter_w4_bottom quarter_w_diff quarter_w4
	
	save "$temp/sample_small_vw_impact.dta", replace
	save "$data2/sample_small_vw_impact.dta", replace	
	****************************************************************************
