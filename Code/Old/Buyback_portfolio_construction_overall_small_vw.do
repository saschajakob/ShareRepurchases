...
*/	
	* Drop all variables of look and rerun three months later	
	drop dist tag tag2 tag3 insample temp temp2 temp3 temp4 temp5 obs1 obs2 obs3 weight t1_weight t2_weight mtemp1-mtemp6 totmk 
		
	}
	
	*drop quarter_w_diff_top quarter_w4_top quarter_w_diff_bottom quarter_w4_bottom quarter_w_diff quarter_w4
	
	save "$temp/sample_36m_small_vw.dta", replace
	save "$data2/sample_36m_small_vw.dta", replace	
	****************************************************************************
