...
*	use "$data2/sample_returns_all_36m_cashretprofitivol.dta"
	...
	* Collapse the data to the portfolio level
	collapse top_pf_ret36m top_pf_ret36m_tc rf mktrf smb hml umd cma rmw ps_vwf, by(month)
	...
	rename top_pf_ret36m ret_mega
	rename top_pf_ret36m_tc ret_tc_mega
	sort month
	...
	* Collapse the data to the portfolio level
	collapse top_pf_ret36m top_pf_ret36m_tc, by(month)
	
	keep if month >= 419
	drop if month > 671
	
	rename top_pf_ret36m ret_large
	rename top_pf_ret36m_tc ret_tc_large
	sort month	
	...
	* Collapse the data to the portfolio level
	...
	rename top_pf_ret36m ret_mid
	rename top_pf_ret36m_tc ret_tc_mid
	sort month	
	...
	* Collapse the data to the portfolio level
	...
	rename top_pf_ret36m ret_small
	rename top_pf_ret36m_tc ret_tc_small
	sort month	
	...
	* Collapse the data to the portfolio level
	...
	rename top_pf_ret36m ret_overall
	rename top_pf_ret36m_tc ret_tc_overall
	sort month	
	...
	* Collapse the data to the portfolio level
	...
	rename top_pf_ret36m ret_500m
	rename top_pf_ret36m_tc ret_tc_500m
	sort month	
