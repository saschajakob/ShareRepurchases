...
# Read STATA file
df = pd.read_stata("/Users/saschajakob/Desktop/Paper 1/return_decomp_data_1980_2019_oval.dta")
...
e1 = np.array([1,0,0])
global_gamma = np.array(pd.read_excel("/Users/saschajakob/Desktop/Paper 1/var_coeff_mat_oval.xlsx",index_col=None, header=None))
...
with warnings.catch_warnings():
    ...
    for permno, key in tqdm(groups):
        for index, row in key.iterrows():
            if row['rep_q'] == 1 and row['mispricing_tag']==4:
                try:
                    idx = index
...
decomp_df.to_stata('/Users/saschajakob/Desktop/Paper 1/decomp_data_single_gamma_oval_fundamental.dta')
